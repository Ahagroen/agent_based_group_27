...
class ATC():
    ...
    def add_aircraft(self,current_time):
        if self.next_ac_time-current_time <=0:
            ...
            return Aircraft(str(self.next_aircraft_name),gate,dept_runway,True,9999999,loading_time),arr_runway
        else:
            return None
    ...
    def populate_schedule(self,total_time:int,gc):
        ...
        while carry < total_time:
            ...
            taxi_time = len(gc.determine_route(gate,arr_runway,[]))*15+180
