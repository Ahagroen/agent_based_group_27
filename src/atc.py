...
class ATC():
    def __init__(self,ac_pace:int,taxi_margin:int,loading_margin:int,gates_list:list):
    ...
    def add_aircraft(self,current_time):
        ...
        if current_time-self.next_ac_time <=0:
            ...
            return Aircraft(gate,current_time+self.taxi_margin,loading_time,0,current_time+loading_time+2*self.taxi_margin)
        else:
            return None
