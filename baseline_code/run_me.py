...
while running:
    ...
    if t == 1:    
        ...
        ac2 = Aircraft(3, 'D', 35, 1, t, nodes_dict)  # As an example we will create one aicraft arriving at node 36 with the goal of reaching node 37
        ac3 = Aircraft(4, 'D', 98, 1, t, nodes_dict)
